        ...
        <DialogHeader className="p-6 pb-0">
          <DialogTitle className="flex items-center gap-3">
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="sm" onClick={() => window.open(vod.video_url, "_blank")}>Watch</Button>
              {vod.tournament_id && (
                <Button variant="outline" size="sm" onClick={() => window.open(`/tournament/${vod.tournament_id}`, "_blank")}>Tournament</Button>
              )}
            </div>
          </DialogTitle>
        </DialogHeader>

        <ScrollArea className="h-full w-full px-6 pt-0 pb-6">
          <div className="space-y-6">
            ...
            {/* Add other collapsible blocks here if needed */}
          </div>
        </ScrollArea>
      </DialogContent>
    </Dialog>
