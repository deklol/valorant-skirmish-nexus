...
import { Trophy, Medal, Award, Target, BarChart3 } from "lucide-react";
...
const BetaLeaderboard = () => {
  ...
  const getRankIcon = (rank: number) => {
    switch (rank) {
      ...
      default:
        return (
          <div className="w-8 h-8 rounded-full bg-[hsl(var(--beta-surface-4))] flex items-center justify-center">
              ...
              >
                ...
                <div className="flex items-center gap-6 text-sm">
                  <div className="text-center hidden sm:block">
                    <p className="font-bold text-purple-400">{player.rank_points || 0}</p>
