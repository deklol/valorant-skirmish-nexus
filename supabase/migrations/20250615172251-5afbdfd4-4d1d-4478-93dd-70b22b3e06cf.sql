...
-- Update perform_veto_action to conform to official BO1 veto logic:
-- After 10 bans (for 11 maps), auto-pick the last map (no user/team claims it), then assign the turn to the home team for side selection.
-- Do NOT mark session as completed until side_choice is recorded.
...
BEGIN
    ...
    away_team_id := session_rec.away_team_id;
    ...
    IF is_bo1 THEN
        -- BO1 logic: Alternate 10 bans, final map is auto-picked, home team picks side
