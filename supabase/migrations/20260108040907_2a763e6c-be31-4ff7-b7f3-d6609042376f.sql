-- Function to recalculate all user statistics from ground truth (completed matches in completed tournaments only)
...
BEGIN
  -- Step 1: Reset all statistics to zero
  UPDATE users SET 
    wins = 0,
    losses = 0,
    tournaments_won = 0,
  ...
  -- Step 2: Calculate and update wins from completed matches in completed tournaments
  ...
  -- Step 3: Calculate and update losses from completed matches in completed tournaments
  ...
  -- Step 4: Calculate and update tournament wins (teams with status = 'winner' in completed tournaments)
  ...
  -- Step 5: Calculate and update tournaments played (distinct completed tournaments user participated in)
