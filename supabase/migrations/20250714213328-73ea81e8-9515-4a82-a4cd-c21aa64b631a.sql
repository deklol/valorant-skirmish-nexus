...
-- Add new shop item categories
UPDATE shop_items SET category = 'skins' WHERE false; -- Just to add the enum value
UPDATE shop_items SET category = 'in_game_items' WHERE false; -- Just to add the enum value
